...
import COLORS from '../../../../source/Constants/Colors.js';
...
export default function SignInEstablishmentScreen({ navigation }) {
  ...
  <>
    ...
    <ScrollView style={styles.container}>
      ...
      <Text style={{color: COLORS.black, fontSize: 30}}>Création d{"'"}un établissement</Text>
      </View>
